...
<body class="wrapper">
    ...
    <main>
        <form action="<%=request.getContextPath()%>/update" method="post" enctype="multipart/form-data" id="data_upload_form">
            <h1>書籍の編集</h1>
            <div class="content_body add_book_content">
                ...
                <div class="content_right">
                    ...
                    <div>
                        <span>説明文</span><span class="care care1">任意</span> <input type="text" name="description" value="${bookDetailsInfo.description}"> <input type="hidden" id="bookId" name="bookId" value="${bookDetailsInfo.bookId}">
                    </div>
                </div>
            </div>
            <div class="addBookBtn_box">
                <button type="submit" id="add-btn" class="btn_returnBook">更新</button>
            </div>
        </form>
    </main>
</body>
